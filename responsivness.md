...
With responsive design, you can create one design and it will automatically adapt itself based on the screen size of the device.

### Why is it important?

Nowadays, you want to reach your users on different devices - phones, tablets, computers.
...
< Add another Subtitle and repeat the template above from "Subtitle" to "Addition materials" as needed.
